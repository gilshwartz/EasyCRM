 ...
 */
	Configure::write('Security.salt', 'PlanningForceCRM&Backend2.5.0');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '12579654103598745632104578 ');
 ...
 */
  ...
  */
        define('EASYCRM_VERSION', '1.0');
        define('EASYCRM_DBVERSION', '1.0');
        define('EASYCRM_OWNER', 'Fiozyx');
        define('EASYCRM_SERIALKEY', '');
?>